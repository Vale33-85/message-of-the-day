...
var chosen_number = current_date.getDate();

console.log("Drawn number: " + chosen_number);
chosen_number--;

var quote_of_day = quotes_of_day[chosen_number];

console.log("Quote of the day");
console.log("Message: " + quote_of_day);